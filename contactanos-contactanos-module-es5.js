...
var ContactanosRoutingModule = /** @class */ (function () {
    function ContactanosRoutingModule() {
    }
    ...
    return ContactanosRoutingModule;
}());
...
var ContactanosComponent = /** @class */ (function () {
    function ContactanosComponent(rou) {
        this.rou = rou;
        this.Mensaje = "";
    ...
    ContactanosComponent.prototype.ngAfterViewChecked = function () {
        _interface_menu__WEBPACK_IMPORTED_MODULE_1__["Disparador"].OnChangeComponent.emit();
    };
    ContactanosComponent.ctorParameters = function () { return [
...
var ContactanosModule = /** @class */ (function () {
...
var FormComponent = /** @class */ (function () {
    function FormComponent(emailServ) {
    ...
    FormComponent.prototype.Validacion = function (type, value) {
        var _this = this;
        var retorno = true;
    ...
    FormComponent.prototype.ProcesoValidación = function (expre, value, tipo) {
        var _this = this;
        var retorno = true;
        if (is_valid_value__WEBPACK_IMPORTED_MODULE_3__["Validate"].value(value)) {
    ...
    FormComponent.prototype.InputValidacion = function (type, value, id) {
    ...
    FormComponent.prototype.ChangeApariencia = function (id, show) {
    ...
    FormComponent.prototype.EnviarCorreo = function () {
        var _this = this;
        if (this.formValidado) {
            if (this.ValidarSend()) {
                var objetoEmail = new src_app_interface_email__WEBPACK_IMPORTED_MODULE_4__["Email"]();
                ...
                this.emailServ.sendEmail(objetoEmail).subscribe(function (x) {
                    _this.showLoading = false;
                    if (x.enviado) {
                        _this.icono = "mail_outline";
                        _this.mensa = "¡Mensaje Enviado!";
                        ...
                        _this.icono = "close";
                        _this.mensa = "¡Mensaje No Enviado!";
                        _this.showMessage = true;
                        setTimeout(function () { return _this.showMessage = false; }, 1200);
                    }
                    console.log(x);
    ...
    FormComponent.prototype.ValidarSend = function () {
