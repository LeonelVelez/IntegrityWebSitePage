...
const routes = [
    {
        path: '',
        loadChildren: () => Promise.all(/*! import() | inicio-inicio-module */[__webpack_require__.e("default~inicio-inicio-module~trabaja-nosotros-trabaja-nosotros-module"), __webpack_require__.e("default~inicio-inicio-module~servicios-servicios-module"), __webpack_require__.e("inicio-inicio-module")]).then(__webpack_require__.bind(null, /*! ./inicio/inicio.module */ "./src/app/inicio/inicio.module.ts")).then(x => x.InicioModule)
    },
    {
        path: 'inicio',
        loadChildren: () => Promise.all(/*! import() | inicio-inicio-module */[__webpack_require__.e("default~inicio-inicio-module~trabaja-nosotros-trabaja-nosotros-module"), __webpack_require__.e("default~inicio-inicio-module~servicios-servicios-module"), __webpack_require__.e("inicio-inicio-module")]).then(__webpack_require__.bind(null, /*! ./inicio/inicio.module */ "./src/app/inicio/inicio.module.ts")).then(x => x.InicioModule)
    ...
    {
        path: 'servicios',
        loadChildren: () => Promise.all(/*! import() | servicios-servicios-module */[__webpack_require__.e("default~inicio-inicio-module~servicios-servicios-module"), __webpack_require__.e("servicios-servicios-module")]).then(__webpack_require__.bind(null, /*! ./servicios/servicios.module */ "./src/app/servicios/servicios.module.ts")).then(x => x.ServiciosModule)
    },
    {
        path: 'contactanos',
        loadChildren: () => Promise.all(/*! import() | contactanos-contactanos-module */[__webpack_require__.e("default~contactanos-contactanos-module~trabaja-nosotros-trabaja-nosotros-module"), __webpack_require__.e("contactanos-contactanos-module")]).then(__webpack_require__.bind(null, /*! ./contactanos/contactanos.module */ "./src/app/contactanos/contactanos.module.ts")).then(x => x.ContactanosModule)
    },
    {
        path: 'trabaja',
        loadChildren: () => Promise.all(/*! import() | trabaja-nosotros-trabaja-nosotros-module */[__webpack_require__.e("default~contactanos-contactanos-module~trabaja-nosotros-trabaja-nosotros-module"), __webpack_require__.e("default~inicio-inicio-module~trabaja-nosotros-trabaja-nosotros-module"), __webpack_require__.e("trabaja-nosotros-trabaja-nosotros-module")]).then(__webpack_require__.bind(null, /*! ./trabaja-nosotros/trabaja-nosotros.module */ "./src/app/trabaja-nosotros/trabaja-nosotros.module.ts")).then(x => x.TrabajaNosotrosModule)
    },
];
...
let AppComponent = class AppComponent {
    constructor(date, ruta) {
        ...
        this.ruta.events.subscribe((x) => {
            if (x instanceof _angular_router__WEBPACK_IMPORTED_MODULE_4__["NavigationStart"]) {
                ...
                if (this.ruta.config.filter(recorre => `/${recorre.path}` === x.url).length === 0) {
    ...
    OnCloseSplash() {
        _interface_menu__WEBPACK_IMPORTED_MODULE_1__["Disparador"].OnChangeComponent.subscribe(() => {
            setTimeout(() => {
                this.splashShow = false;
            }, 1500);
        });
...
let FooterComponent = class FooterComponent {
    ...
    ScrollTo(id) {
        const element = document.getElementById("elegirnos").getBoundingClientRect;
        window.scrollTo({
            top: 0,
            left: 0,
            behavior: 'smooth'
...
let HeaderComponent = class HeaderComponent {
    ...
    ngOnInit() {
        ...
        this.breakpoin.observe(['(min-width:1024px)']).subscribe((retorno) => {
            if (retorno.matches) {
                this.showMenuVar = true;
                this.showMenuSide = false;
                this.ChangeLogo(130, 150, 90, 110);
            }
        });
        this.breakpoin.observe(['(max-width:1023px)']).subscribe((retorno) => {
            if (retorno.matches) {
                this.showMenuVar = false;
                this.showMenuSide = true;
            }
        });
        this.breakpoin.observe(['(min-width:769px)']).subscribe((retorno) => {
            if (retorno.matches) {
                this.widthMenu = "220px";
                this.ChangeLogo(130, 150, 90, 110);
            }
        });
        this.breakpoin.observe(['(max-width:768px)']).subscribe((retorno) => {
            if (retorno.matches) {
                this.widthMenu = "170px";
                this.ChangeLogo(90, 120, 70, 100);
            }
        });
        this.breakpoin.observe(['(max-width:480px)']).subscribe((retorno) => {
            if (retorno.matches) {
                this.widthMenu = "150px";
            }
        });
        this.breakpoin.observe(['(min-width:481px)']).subscribe((retorno) => {
            if (retorno.matches) {
                this.widthMenu = "170px";
            }
        });
    }
    ChangeLogo(altoNotScroll, anchoNotScroll, altoScroll, anchoScroll) {
    ...
    OnCloseMenu() {
        ...
        window.addEventListener("click", (event) => {
            ...
            if (!boton.contains(event.target) && !menu.contains(event.target) && this.IsOpen) {
                this.CloseMenu();
            }
        });
    }
...
let ShowDirective = class ShowDirective {
    constructor(element, ruta) {
        this.element = element;
        this.ruta = ruta;
    }
    ngOnInit() {
        this.AgregarEvento();
        let sons = this.element.nativeElement.childNodes;
    ...
    OnViewPort(sons) {
        ...
        let distanciaElementViewPort = this.element.nativeElement.getBoundingClientRect().top;
        let diferencia = Number(distanciaElementViewPort.toFixed(0)) - Number(altoViewPort.toFixed(0));
        if (diferencia < -70) {
            for (let recorre of sons) {
...
const host = 'https://apiisc.000webhostapp.com/';
const environment = {
    production: false,
