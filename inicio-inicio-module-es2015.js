...
let InicioServiciosComponent = class InicioServiciosComponent {
    constructor(ruter) {
        this.ruter = ruter;
        let s = document.getElementById("container-servicios");
    }
    ngOnInit() {
    }
    GoToServe(parametro) {
...
InicioServiciosComponent.ctorParameters = () => [
...
let OpinionComponent = class OpinionComponent {
    ...
    ClockOpiniones() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let recorre = 0;
            const opinionEle = document.getElementById("opinionParrafo");
            const personaEle = document.getElementById("personaParrafo");
            let primera = true;
            setInterval(() => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                ...
                yield this.ChangeStyle(opinionEle, personaEle);
                if (primera) {
                    recorre++;
    ...
    ChangeStyle(opinionEle, personaEle) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
