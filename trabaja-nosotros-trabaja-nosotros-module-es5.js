...
var TrabajaNosotrosRoutingModule = /** @class */ (function () {
    function TrabajaNosotrosRoutingModule() {
    }
    ...
    return TrabajaNosotrosRoutingModule;
}());
...
var TrabajaNosotrosComponent = /** @class */ (function () {
    function TrabajaNosotrosComponent(emailServ) {
    ...
    TrabajaNosotrosComponent.prototype.ngOnInit = function () {
    };
    TrabajaNosotrosComponent.prototype.ngAfterViewChecked = function () {
        _interface_menu__WEBPACK_IMPORTED_MODULE_6__["Disparador"].OnChangeComponent.emit();
    };
    TrabajaNosotrosComponent.prototype.ChangeFile = function (event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var valida, error, error;
    ...
    TrabajaNosotrosComponent.prototype.SendPdf = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var base64File, objetoPdf;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.formValidado) return [3 /*break*/, 2];
                        if (!(this.formulario.Correo != "" && this.formulario.Nombre != "" && this.inputFileMessage != "Suba su cv pdf")) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.toBase64(this.inputFile)];
                    case 1:
                        base64File = _a.sent();
                        objetoPdf = new _interface_email__WEBPACK_IMPORTED_MODULE_1__["EmailPdf"]();
                        objetoPdf.pdf = base64File;
                        objetoPdf.nombre = this.formulario.Nombre;
                        objetoPdf.correo = this.formulario.Correo;
                        this.showLoading = true;
                        this.emailServ.sendEmailPdf(objetoPdf).subscribe(function (x) {
                            _this.showLoading = false;
                            console.log(x);
                            if (x.enviado) {
                                _this.icono = "mail_outline";
                                _this.mensaje = "¡Mensaje Enviado!";
                                _this.showMessage = true;
                                setTimeout(function () { return _this.showMessage = false; }, 1200);
                                _this.ClearForm();
                            }
                            else {
                                _this.icono = "close";
                                _this.mensaje = "¡Mensaje No Enviado!";
                                _this.showMessage = true;
                                setTimeout(function () { return _this.showMessage = false; }, 12000);
                            }
                        }, function (error) {
                            _this.showLoading = false;
                            console.log(error);
    ...
    TrabajaNosotrosComponent.prototype.ClearForm = function () {
        this.formulario.Correo = "";
        this.formulario.Nombre = "";
        this.inputFileMessage = "Suba su cv pdf";
        this.formulario.File = "";
    };
    TrabajaNosotrosComponent.prototype.toBase64 = function (input) {
    ...
    TrabajaNosotrosComponent.prototype.Validacion = function (type, value) {
        var _this = this;
        var retorno = true;
        switch (type.toUpperCase()) {
            ...
            default:
                if (!is_valid_value__WEBPACK_IMPORTED_MODULE_2__["Validate"].value(value)) {
                    retorno = false;
                    this.mensajeError = this.mensjaes.find(function (x) { return x.tipo === _this.tipoValidacion._EMPTY; }).mensaje;
                }
                break;
        }
        return retorno;
    };
    TrabajaNosotrosComponent.prototype.ProcesoValidación = function (expre, value, tipo) {
        var _this = this;
        var retorno = true;
        if (is_valid_value__WEBPACK_IMPORTED_MODULE_2__["Validate"].value(value)) {
            var expresionReg = expre;
            if (!expresionReg.test(value)) {
                this.mensjaes.forEach(function (x) {
                    if (x.tipo === tipo) {
                        _this.mensajeError = x.mensaje;
                    }
                });
                retorno = false;
            }
    ...
    TrabajaNosotrosComponent.prototype.InputValidacion = function (type, value, id) {
        console.log(value);
    ...
    TrabajaNosotrosComponent.prototype.ChangeApariencia = function (id, show) {
        var parrafoMensaje = document.getElementById(id);
        if (show) {
    ...
    TrabajaNosotrosComponent.ctorParameters = function () { return [
    ...
    return TrabajaNosotrosComponent;
}());
...
var TrabajaNosotrosModule = /** @class */ (function () {
    function TrabajaNosotrosModule() {
    }
...
//# sourceMappingURL=trabaja-nosotros-trabaja-nosotros-module-es5.js.map