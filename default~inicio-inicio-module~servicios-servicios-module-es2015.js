...
let InicioElegirnosComponent = class InicioElegirnosComponent {
    constructor() {
        this.colorFondoTitulo = "rgb(4, 4, 88)";
    }
    ngOnInit() {
        let parrafo = document.querySelector("#container-elegirnos .item:first-child p");
        let fondoParrafo = document.querySelector("#container-elegirnos .item:first-child");
        let fondCard = document.querySelector(".card");
...
let InicioElegirnosModule = class InicioElegirnosModule {
};
...
let TituloComponent = class TituloComponent {
    ...
    ngAfterViewChecked() {
        let tituloel = document.getElementById("cont-titulo" + this.id);
        let border = document.getElementById("border" + this.id);
...
//# sourceMappingURL=default~inicio-inicio-module~servicios-servicios-module-es2015.js.map